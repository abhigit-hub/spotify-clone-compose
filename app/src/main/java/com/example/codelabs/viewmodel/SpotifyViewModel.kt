package com.example.codelabs.viewmodel

import androidx.compose.runtime.MutableState
import androidx.compose.runtime.State
import androidx.compose.runtime.mutableStateOf
import androidx.lifecycle.ViewModel
import com.example.codelabs.model.*
...
class SpotifyViewModel @Inject constructor(): ViewModel() {
    ...
    private fun populateRecentPlayedItems() {
        _recentPlayedItems.value = listOf(
            RecentPlayedItem(
                itemName = "CYC 1",
                itemUrl = "https://thisis-images.scdn.co/37i9dQZF1DZ06evNZWCMvK-default.jpg"
            ),
            RecentPlayedItem(
                itemName = "Lo-Fi | Hip/Hop / Chillhop (Relaxing and Chill Vibes)",
                itemUrl = "https://i.scdn.co/image/ab67706c0000bebb163aeea48afe86ed0c55bfcd"
            ),
            RecentPlayedItem(
        ...
        _artists.value = Artists(
            artists = listOf(
                ...
                ArtistItem(
                    ...
                    artistImageUrl = "https://thisis-images.scdn.co/37i9dQZF1DZ06evO39qAJG-default.jpg"
                ),
                ArtistItem(
                    artistName = "MF DOOM",
